...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark min-h-screen flex flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-xs sticky top-0 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold tracking-tight text-foreground", children: "AI Behavior Playground" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Simulate emergent conversations between two AI agents" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-medium", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-6 py-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
      year,
      ".",
      " ",
...
function ChatBubble({ message, visibleText, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `chat.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: `text-xs font-display font-semibold tracking-wide ${isA ? "text-primary" : "text-accent"}`,
            children: [
              "Agent ",
              message.agentId
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `relative max-w-xs sm:max-w-sm md:max-w-md px-4 py-3 rounded-[4px] break-words text-sm leading-relaxed ${isA ? "agent-a-bubble" : "agent-b-bubble"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: visibleText }),
              isTyping && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `inline-block w-0.5 h-4 ml-0.5 align-middle cursor-blink ${isA ? "bg-primary-foreground" : "bg-accent-foreground"}`,
                  "aria-hidden": "true"
                }
              )
            ]
...
function PersonalitySelect({
  ...
  const ringClass = agentId === "A" ? "focus:ring-primary/40 focus:border-primary/60" : "focus:ring-accent/40 focus:border-accent/60";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "label",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: accentClass, children: [
            "Agent ",
            agentId
          ] }),
          " personality"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: PERSONALITIES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p, children: [
            personalityMeta[p].emoji,
            " ",
            p,
            " — ",
            personalityMeta[p].description
          ] }, p))
        }
      ),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `px-4 py-3 rounded-[4px] ${isA ? "bg-primary/20 border border-primary/30" : "bg-accent/20 border border-accent/30"}`,
...
function applyTemplateVars(template, goal) {
  const goalWords = goal.split(" ").slice(0, 4).join(" ");
  return template.replace(/\{goal\}/g, goal).replace(/\{prevPoint\}/g, goalWords).replace(/\{agentName\}/g, "");
}
function generateConversation(goal, personalityA, personalityB, turns = 7) {
  ...
  for (let i = 0; i < turns; i++) {
    ...
    const agentId = isAgentA ? "A" : "B";
    let pool;
    if (i === 0) {
      pool = tmpl.openers;
    } else if (i >= turns - 2) {
      pool = tmpl.closers.length > 0 ? [...tmpl.closers, ...tmpl.replies] : tmpl.replies;
    } else {
      pool = tmpl.replies;
    }
...
const TYPING_DELAY_PER_CHAR = 28;
const BETWEEN_TURN_DELAY = 800;
const BEFORE_TYPING_DELAY = 600;
...
function useSimulation() {
  ...
  const [currentTyping, setCurrentTyping] = reactExports.useState(null);
  const [visibleContent, setVisibleContent] = reactExports.useState(
    {}
  );
  const timeoutsRef = reactExports.useRef([]);
  const intervalsRef = reactExports.useRef([]);
  ...
  const typeMessage = reactExports.useCallback(
    (msgId, fullText, onComplete) => {
      let charIndex = 0;
  ...
  const startSimulation = reactExports.useCallback(
    (config) => {
      clearAllTimers();
      setMessages([]);
      setVisibleContent({});
      setStatus("running");
      setCurrentTyping(null);
      const turns = Math.floor(Math.random() * 3) + 6;
      ...
      conversation.forEach((turn, index2) => {
        ...
        cumulativeDelay += BEFORE_TYPING_DELAY + typingDuration + BETWEEN_TURN_DELAY;
        if (index2 === conversation.length - 1) {
...
function PlaygroundPage() {
  ...
  const [personalityA, setPersonalityA] = reactExports.useState("Logical");
  const [personalityB, setPersonalityB] = reactExports.useState("Aggressive");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center px-4 py-10 sm:py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8 sm:mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground tracking-tight mb-2", children: "AI Behavior Playground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm sm:text-base max-w-lg mx-auto", children: "Simulate conversations between two AI agents with distinct personalities and observe emergent behavior." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl bg-card border border-border rounded-2xl shadow-xl overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 sm:p-6 border-b border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "form",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              goal.trim().length === 0 && hasStarted === false && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-xs text-muted-foreground/60",
                  "data-ocid": "simulation.goal_hint",
                  children: "Enter a goal to enable the simulation."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 items-end", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-full sm:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "submit",
                  disabled: !canStart,
                  ...
                  children: isRunning ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3.5 h-3.5 rounded-full border-2 border-primary-foreground/30 border-t-primary-foreground animate-spin" }),
                    "Running…"
          ...
          children: !hasStarted ? (
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-muted flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-semibold text-foreground mb-1", children: "No conversation yet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground max-w-xs", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: "Start Simulation" }),
                    "."
                  ] })
                ]
              }
            ...
            "div",
            {
              ...
              children: [
                ...
                currentTyping && /* @__PURE__ */ jsxRuntimeExports.jsx(TypingIndicator, { agentId: currentTyping }),
                status === "complete" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "text-center py-3",
                    "data-ocid": "simulation.complete_state",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-display font-semibold text-muted-foreground/60 border border-border/50 rounded-full px-3 py-1", children: "— Simulation complete —" })
                  }
                ),
      ...
      hasStarted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 sm:px-6 py-3 border-t border-border bg-card flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `w-2 h-2 rounded-full ${isRunning ? "bg-primary animate-pulse" : "bg-muted-foreground/40"}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body", children: isRunning ? "Simulation running…" : `${messages.length} messages · complete` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "A" }),
            " ·",
            " ",
            personalityA
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: "B" }),
            " ·",
            " ",
            personalityB
          ] })
    ...
    !hasStarted && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-wrap gap-2 justify-center", children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlaygroundPage, {}) });
}
